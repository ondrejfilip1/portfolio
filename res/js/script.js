...
document.body.onload = () => {
  ...
  if (randomNumber == 0) {
    gradientText.style.background =
      "-webkit-linear-gradient(0deg, #642b73, #c6426e, #642b73, #c6426e)";
  } else if (randomNumber == 1) {
    gradientText.style.background =
      "-webkit-linear-gradient(0deg, #4568dc, #b06ab3, #4568dc, #b06ab3)";
  } else if (randomNumber == 2) {
    gradientText.style.background =
      "-webkit-linear-gradient(0deg, #ff5f6d, #ffc371, #ff5f6d, #ffc371)";
  } else if (randomNumber == 3) {
    gradientText.style.background =
      "-webkit-linear-gradient(0deg, #f3904f, #574931, #f3904f, #574931)";
  }
...
checkbox.addEventListener("change", () => {
  ...
  descriptionWork.style.boxShadow = invertFilter ? "rgba(0, 0, 0, 0.36) 0px 22px 70px 4px" : "rgba(255, 255, 255, 0.36) 0px 22px 70px 4px";
});
...
const updateDescription = (e) => {
  ...
  if (target && target.id.startsWith("work-hover-")) {
    ...
    switch (target.id) {
      case "work-hover-1":
        newDescription =
          'Paintings by Tim Lee<br><span class="yellow-text">Bootstrap, Custom CSS</span>';
        break;
      case "work-hover-2":
        newDescription =
          'Cookie clicker<br><span class="yellow-text">Custom CSS & JS</span>';
        break;
      case "work-hover-3":
        newDescription =
          'Modern school website<br><span class="yellow-text" style="">Bootstrap, Custom CSS</span>';
        break;
      case "work-hover-4":
        newDescription =
          'Modern website for Pilsen Region<br><span class="yellow-text" style="">React, MUI, shadcn/ui, Tailwind CSS</span>';
        break;
      default:
        newDescription = "";
    }
